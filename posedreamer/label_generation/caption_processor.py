"""Caption post-processing shared by the generation scripts (e.g. injecting
randomised ethnicity terms for demographic diversity)."""
import random
...
class CaptionProcessor:
    ...
    def add_ethnic_labels(self, prompt: str, p: float = 0.6) -> str:
        words = prompt.split()
